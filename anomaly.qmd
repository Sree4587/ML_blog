...
```
<img class="img-fluid" src="D:\Project\Final\images\dataplot1.png" width= "30%" >

```{code}
plot_dates_values(df_daily_jumpsup)
```
<img class="img-fluid" src="D:\Project\Final\images\dataplot2.png" width= "30%" >
...
plt.legend()
```
<img class="img-fluid" src="D:\Project\Final\images\train_val.png" width= "30%" >
...
```
<img class="img-fluid" src="D:\Project\Final\images\anomaly.png" width= "30%" >

Reconstruction error threshold:  0.1898735654680075
...
plt.show()
```
<img class="img-fluid" src="D:\Project\Final\images\final_nonlinear.png" width= "40%" >
...
<img class="img-fluid" src="D:\Project\Final\images\anomaly_final.png" width= "40%" >
